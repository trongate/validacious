...
$validation_errors = [
	...
	// Erreurs des Administrateurs Trongate
	'username_taken'             => 'Le [label] est déjà pris. Veuillez en choisir un autre.',
	'username_in_use'            => 'Le [label] est déjà utilisé par un autre compte.'
];
