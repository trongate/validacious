...
$validation_errors = [
	...
	// Trongate Administrators Errors
	'username_taken'             => 'The [label] is already taken. Please choose another.',
	'username_in_use'            => 'The [label] is already in use by another account.'
];
